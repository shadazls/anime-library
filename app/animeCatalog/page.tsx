    ...
    const handleDeleteAnime = async (animeId: ObjectId) => {
        try {
            const response = await fetch(
                `/api/animes/deleteAnime?id=${animeId}`,
                {
                    method: 'DELETE',
                }
            );
            ...
            if (response.ok) {
                setAnimes((prevAnimes) =>
                    prevAnimes.filter((anime) => anime._id !== animeId)
                );
            } else {
    ...
    return (
        <section className="flex flex-col gap-4 py-8 md:py-10 mx-24">
            ...
            <div className="flex h-10 space-x-4 justify-end">
                <Button onPress={onOpen} color="primary" aria-label="Add Anime">
                    Add an anime
                </Button>
                <Modal
                    isOpen={isOpen}
                            ...
                            <>
                                ...
                                >
                                    ...
                                    <Textarea
                                        ...
                                        onValueChange={(value) =>
                                            handleFormChange('Synopsis', value)
                                        }
                                    />
                                    <Input
                                        label="Genres"
